public class Hero0630 {
    ...
    public void attack() {
        ...
        System.out.println(this.name + " gave 5 points of damage on the enemy!");
    }
    ...
    public void doubleAttack() {
        ...
        System.out.println(this.name + " gave 10 points of damage on the enemy!");
    }
